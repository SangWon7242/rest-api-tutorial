...
public class BaseInitData {
  ...
  @Bean
  ApplicationRunner baseInitDateApplicationRunner() {
    return args -> {
      self.work1();
    };
  }
  ...
  public void work1() {
    ...
    post1.addComment("댓글1-1");
    post1.addComment("댓글1-2");
    post1.addComment("댓글1-3");
    post2.addComment("댓글2-1");
    post2.addComment("댓글2-2");
  }
}
